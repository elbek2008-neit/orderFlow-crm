    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehauseProducts", x => new { x.WarehauseId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_WarehauseProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WarehauseProducts_Warehouses_WarehauseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehauseProducts_ProductId",
                table: "WarehauseProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehauseProducts_WarehauseId_ProductId",
                table: "WarehauseProducts",
                columns: new[] { "WarehauseId", "ProductId" });
        }
